        ...
        <div className="">
          <div className="relative md:opacity-100 md:mx-0">
            ...
            <div className="absolute top-1/3 md:top-0 md:right-0 w-full md:w-[400px] mt-8 px-2 justify-center md:justify-start">
              ...
              <div className="flex justify-center md:justify-end gap-2 mr-0 md:mr-6">
                <button className="border border-gray-200 rounded-xl px-5 py-[12px] text-white text-xs sm:text-base">
                  2023 collection
                </button>
                <button className="bg-[#645a52] rounded-xl px-5 py-[12px] text-white flex items-center justify-center gap-2 text-xs sm:text-base">
                  Shop now
