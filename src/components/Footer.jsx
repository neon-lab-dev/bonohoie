...
export const Footer = () => {
  return (
    <div className='bg-[#4B64E6] h-[700px] relative'>

            <div className='md:ml-10 md:mt-16 w-fit absolute left-0 top-0'>
                <div className='flex mb-10'><img src={IMAGES.b} /> <img src={IMAGES.heart_blue} /> <img src={IMAGES.homie} /> </div>
                <p className='text-white text-base md:w-[30vw] md:mb-5'>Yorem ipsum dolor sit amet, consectetur adipiscing elit. 
            ...
            <div className='absolute grid grid-cols-3 right-0 top-0 md:ml-10 md:mt-16 w-fit gap-10'>
            ...
            <img src={IMAGES.spreading_happiness_white_small}  className=' md:hidden absolute bottom-0 left-0  w-full ' />
            <img src={IMAGES.footer_image} alt='footer' className='absolute bottom-0 left-0  sm:left-32 md:left-1/4 lg:left-1/3 object-contain xl:h-[600px] h-[500px]  grayscale' />
            <div className='bg-[#2D33C8] absolute bottom-0 w-[100vw]'>
                <img src={IMAGES.footer_design} alt='footer' className=' h-[30px] w-full' />
            </div>
        </div>
  )
}
