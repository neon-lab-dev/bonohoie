        ...
        <div className="mt-7 md:mt-10 flex flex-col md:flex-row gap-5">
          ...
          <div className="h-[248px] lg:h-[520px] w-full max-w-[398px] md:max-w-[354px] overflow-hidden rounded-3xl mb-4 relative">
            ...
            <div className="flex flex-row md:flex-col absolute bottom-10 justify-between px-6 w-full">
              ...
              <button className="rounded-xl py-2 lg:p-4 text-white flex bg-white/40 mt-5 w-[140px] justify-center items-center gap-2">
                Shop now
          ...
          <div className="h-full md:h-[500px] lg:h-[570px]">
            <div className="bg-[#F82456] h-[252px] w-full max-w-[398px] md:max-w-[354px] overflow-hidden rounded-3xl relative">
            <img src={IMAGES.best_deals} alt="best" className=" absolute bottom-0 right-0" />
              ...
              <button className="border-white border-2 rounded-xl py-2 lg:p-4 text-white flex m-6 w-[140px] justify-center items-center gap-2">
                Shop now
                <img src={IMAGES.arrow_white} className="" />
              </button>
            </div>
            ...
            <div className="h-[248px] overflow-hidden rounded-3xl mt-5 relative">
              <img
                src={IMAGES.infant}
                alt="child1"
