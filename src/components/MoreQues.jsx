...
export const MoreQues = () => {
  return (
    <div className="bg-[#F82456] rounded-2xl flex flex-col justify-between relative md:h-[220px] md:flex-row md:mx-7  ">
        <div className="flex flex-col justify-center md:ml-7 p-10 md:p-0">
          <p className="text-3xl md:text-4xl lg:text-5xl text-white font-semibold ">Got more questions ?</p>
