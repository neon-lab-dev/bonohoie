  ...
  return (
        ...
        <div className=''>
            <div className='mx-4 relative md:opacity-100'>
                <div className='hidden md:flex md:flex-col absolute top-0 left-0 ml-8 mt-6'>
                    ...
                    <p className='text-white mt-8 w-[200px] '>Both kids and their happy parents love us</p>
                </div>
                <img src={IMAGES.hero} alt='hero' className='h-[550px] md:h-[640px] object-cover md:w-full rounded-2xl brightness-50'/>
                <img src={IMAGES.bonhomie_yellow} alt='bonhomie_yellow' className='absolute bottom-6  w-full '/>
                <div className='absolute top-1/3 md:top-0 md:right-0 md:w-[300px] m-6'>
                    ...
                    <div className='flex justify-center gap-2'>
                        ...
                        <button className='bg-white/50 rounded-lg p-2 text-white flex'>Shop now<img src={IMAGES.arrow_white} className='mt-1 ml-1'/></button>
                    </div>
                </div>
    ...
    {/* why are we loved starts here */}
        <div>
            ...
            <div className='mt-10 md:hidden'>
                ...
                <div className='h-[240px] overflow-hidden mx-4 rounded-3xl mb-4 relative'>
                    <img src={IMAGES.girls2} alt='child1' className='h-[240px] object-cover brightness-50 w-full' />
                    <div className='flex absolute bottom-10 justify-between px-6 w-full'>
                        <div>
            ...
            <div className='md:mt-10 hidden md:grid md:grid-cols-[25%_25%_50%] md:h-[500px] lg:h-[570px] mb-7'>
                <div className='h-full md:h-[500px] lg:h-[570px] overflow-hidden mx-2 lg:mx-4 rounded-3xl mb-4 relative'>
                    <img src={IMAGES.boys1} alt='child1' className='h-full object-cover brightness-50' />
                ...
                <div className='h-full md:h-[500px] lg:h-[570px] grid grid-rows-[60%_40%] justify-between'>
                    ...
                    <div className='h-full overflow-hidden mx-2 lg:mx-4 rounded-3xl mb-4 relative'>
                        <img src={IMAGES.infant} alt='child1' className='h-full w-full brightness-50' />
                ...
                <div className='h-full md:h-[500px] lg:h-[570px] overflow-hidden mx-2 lg:mx-4 rounded-3xl mb-4 relative'>
                    <img src={IMAGES.girls1} alt='child1' className='h-full object-cover w-full brightness-50' />
                    <div className='flex absolute bottom-10 justify-between px-6 w-full'>
                        <div>
        ...
        <div className='hidden md:block' >
            ...
            <div className='grid md:grid-cols-[33%_33%_33%]  justify-center overflow-x-scroll mb-10'>
                <div className='hidden md:block mx-2 relative my-7'>
                    ...
                    <img src={IMAGES.heart} className='absolute top-3 right-8 hidden md:block' />
                    <p className='absolute top-3 left-3 hidden md:block'>Beige Shirt</p>
                    <div className='rounded-md bg-white absolute top-3 right-3 md:hidden'>
                        <img src={IMAGES.plus_black} className='p-3'/>
                    </div>
                    <div className='flex justify-between'>
                ...
                <div className='hidden md:block mx-2 relative my-7'>
                    ...
                    <p className='absolute top-3 left-3 hidden md:block'>Blue Shirt</p>
                    <div className='rounded-md bg-white absolute top-3 right-3 md:hidden'>
                        <img src={IMAGES.plus_black} className='p-3'/>
                    </div>
                    <div className='flex justify-between'>
                ...
                <div className='hidden md:block mx-2 relative my-7'>
                    ...
                    <img src={IMAGES.heart} className='absolute top-3 right-14 hidden md:block' />
                    <p className='absolute top-3 left-3 hidden md:block'>White Shirt</p>
    ...
    {/* join the happiness club */}
        <div className='relative'>
            <img src={IMAGES.group2} alt='group2' className='w-[95vw] m-auto object-cover h-[500px] md:h-[550px] rounded-xl brightness-50'/>
            ...
            <div className='md:hidden flex flex-col absolute top-0 left-0 justify-between items-center h-full'>
                ...
                <p className=' text-white text-5xl lg:text-7xl font-black  m-auto text-center'>JOIN THE HAPPINESS CLUB</p>
